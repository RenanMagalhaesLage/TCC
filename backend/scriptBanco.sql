...
VALUES
  ...
  ('Planejado', false, 'Café', 'Semente G', 520, 58, 28.0, 'Adubo U', '2024-09-01', '2024-03-01', 180, 0, 0, 0, 0, 0, 0, 180, 230.0, 0, 0, NOW(), NOW(), 115, 'Safra 7'),
  ('Planejado', false, 'Milho', 'Semente H', 680, 68, 33.0, 'Adubo V', '2024-10-01', '2024-04-01', 160, 0, 0, 0, 0, 0, 0, 240, 290.0, 0, 0, NOW(), NOW(), 125, 'Safra 8');

INSERT INTO custos (name, unit, quantity, price, category, totalValue, date, note, safraId, status, type, createdAt, updatedAt) VALUES
('Calcário', 'tonelada', 10, 120.00, 'Corretivos e Fertilizantes', 1200.00, NOW(), 'Aplicação de calcário no solo', 1, false, 'Planejado', NOW(), NOW()),
('Herbicida', 'litro', 30, 18.00, 'Defensivos', 540.00, NOW(), 'Controle de ervas daninhas', 1, false, 'Planejado', NOW(), NOW()),
('Combustível', 'litro', 500, 5.00, 'Operações', 2500.00, NOW(), 'Combustível para máquinas agrícolas', 1, false, 'Planejado', NOW(), NOW()),
('Semente de Milho', 'saco', 200, 100.00, 'Semente', 20000.00, NOW(), 'Sementes para plantio de milho', 1, false, 'Planejado', NOW(), NOW()),
('Arrendamento de Terra', 'hectare', 50, 1000.00, 'Arrendamento', 50000.00, NOW(), 'Arrendamento para cultivo de soja', 1, false, 'Planejado', NOW(), NOW()),
('Adubo Orgânico', 'kg', 200, 8.00, 'Corretivos e Fertilizantes', 1600.00, NOW(), 'Adubo orgânico para solo', 1, false, 'Planejado', NOW(), NOW()),
('Manejo de Irrigação', 'hora', 100, 20.00, 'Operações', 2000.00, NOW(), 'Serviços de manejo de irrigação', 1, false, 'Planejado', NOW(), NOW()),
('Seguro Agrícola', 'contrato', 1, 5000.00, 'Administrativo', 5000.00, NOW(), 'Seguro para safra de soja', 1, false, 'Planejado', NOW(), NOW()),
('Máquinas e Equipamentos', 'unidade', 1, 15000.00, 'Administrativo', 15000.00, NOW(), 'Aquisição de novos equipamentos agrícolas', 1, false, 'Planejado', NOW(), NOW());
('Fertilizante', 'kg', 100, 15.00, 'Corretivos e Fertilizantes', 1500.00, NOW(), 'Fertilizante nitrogenado para solo', 1, false, 'Planejado', NOW(), NOW()),
('Pesticida', 'litro', 50, 16.00, 'Defensivos', 800.00, NOW(), 'Controle de pragas', 1, false, 'Planejado', NOW(), NOW()),
('Transporte', 'viagem', 2, 600.00, 'Operações', 1200.00, NOW(), 'Transporte de grãos', 1, false, 'Planejado', NOW(), NOW()),
('Mão de Obra', 'hora', 200, 12.50, 'Operações', 2500.00, NOW(), 'Trabalhadores rurais', 1, false, 'Planejado', NOW(), NOW()),
('Equipamento', 'unidade', 1, 3000.00, 'Administrativo', 3000.00, NOW(), 'Compra de trator', 1, false, 'Planejado', NOW(), NOW()),
('Seguro', 'contrato', 1, 1100.00, 'Administrativo', 1100.00, NOW(), 'Seguro da safra', 1, false, 'Planejado', NOW(), NOW());
